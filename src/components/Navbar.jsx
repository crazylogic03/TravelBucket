...
function Navbar({ activeView, onViewChange }) {
  ...
  return (
    <header
      className={`sticky top-0 z-10 bg-white bg-opacity-90 backdrop-blur-md transition-shadow duration-300 ${scrolled ? 'shadow-md' : ''
        }`}
    >
            ...
            <ul className="flex bg-neutral-100 rounded-lg p-1 shadow-sm">
              <li>
                <button
                  ...
                  className={`flex items-center px-4 py-2 rounded-lg transition-colors ${activeView === 'list'
              ...
              <li>
                <button
                  ...
                  className={`flex items-center px-4 py-2 rounded-lg transition-colors ${activeView === 'map'
                    ? 'bg-white text-primary-500 shadow-sm'
                    : 'text-neutral-600 hover:text-neutral-900'
                    }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`flex items-center px-4 py-2 rounded-lg transition-colors ${activeView === 'add'
                    ? 'bg-white text-primary-500 shadow-sm'
                    : 'text-neutral-600 hover:text-neutral-900'
                    }`}
                >
